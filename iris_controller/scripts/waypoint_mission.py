...
class WaypointMission:
    ...
    def callback_gps(self, msg):
        ...
        rospy.loginfo("Latitude: {}, Longitude: {}".format(self.latitude, self.longitude))


    def callback_alt(self, msg):
        self.altitude = msg.data
        rospy.loginfo("Altitude: {}".format(self.altitude))
    ...
    def handle_waypoint(self, waypoints):
        ...
        for wp in self.waypoints:
            ...
            waypoint.x_lat = wp[0] # latitude
            waypoint.y_long = wp[1] # longitude
            waypoint.z_alt = wp[2]  # altitude
            waypoint.param1 = 0
            waypoint.param2 = 1
            waypoint.param3 = 0
            waypoint.param4 = 0
...
if __name__ == '__main__':
    ...
    wp_mission = WaypointMission()  # init Waypoint Mission class
    ...
    waypoints = [[-35.36215075, 149.16507305, 100],
                 [-35.36239332, 149.16558454, 100],
                 [-35.36316044, 149.16572031, 50],
                 [-35.36378769, 149.16527787, 20]] # sample waypoints Latitude Longitude Altitude
